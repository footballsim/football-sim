...
- **背骨（＝“憲法”）は不変**：①1日1回 ②監督が主人公 ③漫画風ビジュアル。要望で変えるのは“機能”であって、この3本柱は動かさない（フィードバック駆動の最大の罠＝コンセプト崩壊を防ぐ）。
...
- **完成の定義（当面）**：9月末＝**Web版 v1.0**（絞り込み・無料・単一リーグ・軽AI/物語）を出し切る。Steam/多言語/課金/深いメタはローンチ後の成長（[ROADMAP.md](ROADMAP.md)）。
