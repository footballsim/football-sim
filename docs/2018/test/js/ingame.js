...
//    window.onbeforeunload = function() { return "ゲームを終了します。"; };
    ...
    app.controller('SettingCtrl', ['$scope', '$rootScope', '$http',
        function($scope, $rootScope, $http) {
            ons.ready(function() {
                if (sessionStorage.getItem('page') != 'ingame') {
                ...
                $rootScope.teamJPN = env.teamJPN;
                $rootScope.result = env.result;
                $rootScope.glPoint = env.glPoint;
                $rootScope.playerPoint = $rootScope.lastPlayerPoint
                    = env.playerPoint;
                $rootScope.stage = env.stage;

                $rootScope.game = new Game();
                $rootScope.game.team1 = new Team(env.teamJPN.name,
                        env.teamJPN.players, env.teamJPN.lineup,
                        env.teamJPN.default_system,
                        env.teamJPN.default_tactics,
                        env.teamJPN.default_keyplayer,
                        env.teamJPN.team_color, env.teamJPN.flag_image);
                $scope.game = $rootScope.game;

                var country = '';
                switch ($rootScope.stage) {
                    case 0:
                        $scope.titleimg = 'images/prematch.png';
                        $scope.game.date = '2018年6月12日';
//                        $scope.game.weather = '快晴';
                        country = '64';
                        break;
                    case 1:
                        $scope.titleimg = 'images/mes-gl1.png';
                        $scope.game.date = '2018年6月19日';
//                        $scope.game.weather = '快晴';
                        country = '58';
                        break;
                    case 2:
                        $scope.titleimg = 'images/mes-gl2.png';
                        $scope.game.date = '2018年6月25日';
//                        $scope.game.weather = '快晴';
                        country = '60';
                        break;
                    case 3:
                        $scope.titleimg = 'images/mes-gl3.png';
                        $scope.game.date = '2018年6月28日';
//                        $scope.game.weather = '快晴';
                        country = '61';
                        break;
                    case 4:
                        if ($rootScope.glPoint[0].country == '日本') {
                            $scope.titleimg = 'images/mes-ft1.png';
                            $scope.game.date = '2018年7月3日';
//                            $scope.game.weather = '快晴';
                            country = '65';
                        } else {
                            $scope.titleimg = 'images/mes-ft2.png';
                            $scope.game.date = '2018年7月2日';
//                            $scope.game.weather = '快晴';
                            country = '66';
                        }
                        break;
                    case 5:
                        if ($rootScope.glPoint[0].country == '日本') {
                            $scope.titleimg = 'images/mes-ss1.png';
                            $scope.game.date = '2018年7月7日';
//                            $scope.game.weather = '快晴';
                            country = '69';
                        } else {
                            $scope.titleimg = 'images/mes-ss2.png';
                            $scope.game.date = '2018年7月6日';
//                            $scope.game.weather = '快晴';
                            country = '63';
                        }
                        break;
                    case 6:
                        if ($rootScope.glPoint[0].country == '日本') {
                            $scope.titleimg = 'images/mes-sf1.png';
                            $scope.game.date = '2018年7月11日';
//                            $scope.game.weather = '快晴';
                            country = '70';
                        } else {
                            $scope.titleimg = 'images/mes-sf2.png';
                            $scope.game.date = '2018年7月10日';
//                            $scope.game.weather = '快晴';
                            country = '68';
                        }
                        break;
                    case 7:
                        if ($rootScope.glPoint[0].country == '日本') {
                            $scope.titleimg = 'images/mes-fm1.png';
                            $scope.game.date = '2018年7月15日';
//                            $scope.game.weather = '快晴';
                            country = '68';
                        } else {
                            $scope.titleimg = 'images/mes-fm2.png';
                            $scope.game.date = '2018年7月15日';
//                            $scope.game.weather = '快晴';
                            country = '70';
                        }
                ...
                $http.get('remote.php?action=getteam&id=' + country + '&t='
                        + FBSIM_VERSION).
                    success(function(data, status, headers, config) {
                        $rootScope.game.team2 = new Team(data.name,
                                data.players, data.default_lineup,
                                data.default_system, data.default_tactics,
                                data.default_keyplayer, data.team_color,
                                data.flag_image);
                    }).
            ...
            $scope.submit = function() {
                $scope.myNavigator.resetToPage(
                        'views/tournament/ingame.html?v=' + FBSIM_VERSION);
            };
        }]);
    ...
    app.controller('InGameCtrl',
        ...
        function($scope, $rootScope, $compile) {
            ...
            $scope.updateScene = function(scene) {
                ...
                if (scene.offence.name == '日本'
                        && (scene.result == '成功'
                            || scene.result == 'ゴール！！')) {
                    $rootScope.playerPoint += 35;
                    point = '（+35）';
                    if ($rootScope.stage > 0 && scene.result == 'ゴール！！') {
                        $rootScope.playerPoint += 300;
                        point += '（+300）';
                    }
                } else if (scene.defence.name == '日本'
                        && (scene.result == '失敗'
                            || scene.result == 'カウンター'
                            || scene.result == 'GK防いだ！')) {
                    $rootScope.playerPoint += 35;
            ...
            $scope.nextChanceScene = function() {
                ...
                {
                    var icon;
                    var winp = [100, 500, 300, 500, 1000, 2000, 3000, 5000];
                    var drawp = [50, 250, 150, 250, 0, 0, 0, 0];

                    if ($scope.game.team1.score > $scope.game.team2.score) {
                        icon = '◯';
                        $rootScope.playerPoint += winp[$rootScope.stage];
                        // console.log('勝利', winp[$rootScope.stage]);
                    } else if ($scope.game.team1.score < $scope.game.team2.score) {
                        icon = '●';
                    } else {
                        icon = '△';
                        $rootScope.playerPoint += drawp[$rootScope.stage];
                        // console.log('引き分け', drawp[$rootScope.stage]);
                    }

                    // 無失点ポイント
                    if ($rootScope.stage > 0 && $scope.game.team2.score == 0) {
                        $rootScope.playerPoint += 300;
                        // console.log('無失点', 300);
                    }

                    $rootScope.result[$rootScope.stage]
                        = {country: $scope.game.team2.name,
                    ...
                    if ($scope.game.chanceNo >= 16 && icon == '△') {
                        $scope.myNavigator.resetToPage(
                                'views/tournament/ingame_pk.html?v='
                                + FBSIM_VERSION);
                    } else {
                        $scope.myNavigator.resetToPage(
                                'views/tournament/ingame_result.html?v='
                                + FBSIM_VERSION);
                    }
                } else {
            ...
            $scope.setting = function() {
                $scope.myNavigator.pushPage(
                        'views/tournament/ingame_setting.html?v='
                        + FBSIM_VERSION);
            };
        ...
        function($scope, $rootScope, $compile) {
            ...
            $scope.nextButton = function() {
                while (1) {
                    if ($scope.offset == 0) {
                        if ($scope.side == 1) {
                            if ($scope.pk1 + 5 - $scope.col < $scope.pk2
                                || $scope.pk2 + 5 - $scope.col < $scope.pk1) {
                                break;
                            }
                        } else {
                            if ($scope.pk1 + 4 - $scope.col < $scope.pk2
                                || $scope.pk2 + 5 - $scope.col < $scope.pk1) {
                                break;
                            }
                        }
                    } else if ($scope.side == 1 && $scope.pk1 != $scope.pk2) {
                        break;
                    }
                    ...
                    if (Math.random() <= 0.7) {
                        $scope['pk' + $scope.side] += 1;
                        $scope['row' + $scope.side][$scope.col] = '◯';
                    } else {
                        $scope['row' + $scope.side][$scope.col] = '☓';
                    }
                ...
                $rootScope.result[$rootScope.stage].pk1 = $scope.pk1;
                $rootScope.result[$rootScope.stage].pk2 = $scope.pk2;
                if ($scope.pk1 > $scope.pk2) {
                    $rootScope.playerPoint
                        += [1000, 2000, 3000, 5000][$rootScope.stage - 4];
                    // console.log('勝利(PK)',
                    //         [1000, 2000, 3000, 5000][$rootScope.stage - 4]);
                }
                $scope.myNavigator.resetToPage(
        ...
        function($scope, $rootScope, $compile, $http) {
            ons.ready(function() {
                ...
                $scope.addRanking = function() {
                    $http.get('remote.php?action=addranking&name='
                            + encodeURIComponent($rootScope.name) + '&point='
                            + encodeURIComponent($rootScope.playerPoint)).
                        success(function(data, status, headers, config) {
                        }).
                        error(function(data, status, headers, config) {
                            console.log("ERROR!!!!!!!!");
                ...
                $scope.result = $rootScope.result[$rootScope.stage];
                ...
                if ($rootScope.stage == 0) {
                    $http.get('remote.php?action=incp').
                        success(function(data, status, headers, config) {
                        }).
                        error(function(data, status, headers, config) {
                            console.log("ERROR!!!!!!!!");
                        });
                } else if ($rootScope.stage == 3) {
                    for (i = 1; i <= 3; i++) {
                        r = $rootScope.result[i];
                        $rootScope.glPoint[0].goalFor += r.score1;
                        $rootScope.glPoint[0].goalAgainst += r.score2;
                        $rootScope.glPoint[i].goalFor += r.score2;
                        $rootScope.glPoint[i].goalAgainst += r.score1;
                        if (r.score1 > r.score2) {
                            $rootScope.glPoint[0].win += 1;
                            $rootScope.glPoint[i].lose += 1;
                            $rootScope.glPoint[0].point += 3;
                        } else if (r.score1 < r.score2) {
                            $rootScope.glPoint[i].win += 1;
                            $rootScope.glPoint[0].lose += 1;
                            $rootScope.glPoint[i].point += 3;
                        } else {
                            $rootScope.glPoint[0].draw += 1;
                            $rootScope.glPoint[i].draw += 1;
                            $rootScope.glPoint[0].point += 1;
                            $rootScope.glPoint[i].point += 1;
                        }
                    }
                    $rootScope.glPoint.sort(function(a, b) {
                        if (a.point > b.point)
                            return -1;
                        if (a.point < b.point)
                            return 1;
                        if (a.goalFor - a.goalAgainst
                                > b.goalFor - b.goalAgainst)
                            return -1;
                        if (a.goalFor - a.goalAgainst
                                < b.goalFor - b.goalAgainst)
                            return 1;
                    ...
                    // console.table($rootScope.glPoint);

                    if ($rootScope.glPoint[0].country == '日本'
                            || $rootScope.glPoint[1].country == '日本') {
                        if ($rootScope.glPoint[0].country == '日本') {
                            $rootScope.playerPoint += 850;
                            // console.log('1位通過', 850);
                        } else {
                            $rootScope.playerPoint += 600;
                            // console.log('2位通過', 600);
                        }
                        $http.get('remote.php?action=inct').
                            success(function(data, status, headers, config) {
                            }).
                            error(function(data, status, headers, config) {
                                console.log("ERROR!!!!!!!!");
                ...
                } else if ($rootScope.stage >= 4) {
                    r = $rootScope.result[$rootScope.stage];
                    if (r.score1 > r.score2
                        || (r.score1 == r.score2 && r.pk1 > r.pk2)) {
                        if ($rootScope.stage == 7) {
                            $http.get('remote.php?action=incv').
                ...
                $scope.playerPoint
                    = Number($rootScope.playerPoint
                            - $rootScope.lastPlayerPoint).toLocaleString();
                $scope.$apply();
            });
            ...
            $scope.submit = function() {
                ...
                env.teamJPN.lineup = $rootScope.game.team1.lineup;
                env.teamJPN.default_system
                    = system_data[$rootScope.game.team1.system].name;
                env.teamJPN.default_tactics = $rootScope.game.team1.tactics;
                env.teamJPN.default_keyplayer = $rootScope.game.team1.keyplayer;
                ...
                switch ($rootScope.stage) {
                    ...
                    case 3:
                        if ($rootScope.glPoint[0].country == '日本'
                                || $rootScope.glPoint[1].country == '日本') {
                            page = 'groupleague_win';
                        } else {
                            page = 'groupleague_lose';
                        }
                        break;
                    case 4:
                    case 5:
                    ...
                    case 7:
                        ...
                        if (r.score1 > r.score2
                            ...
                            page = 'tournament_lose';
                        }
                        break;
                }
                env.glPoint = $rootScope.glPoint;
                env.playerPoint = $rootScope.playerPoint;
                env.stage = $rootScope.stage;
                sessionStorage.setItem('env', JSON.stringify(env));
                sessionStorage.setItem('page', page);
                location.href = sessionStorage.getItem('url') + page + '.html';
            };
        }]);
