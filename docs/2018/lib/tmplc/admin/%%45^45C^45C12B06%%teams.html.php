<?php /* Smarty version 2.6.25-dev, created on 2016-04-27 20:20:53
         compiled from editor/teams.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'editor/teams.html', 53, false),)), $this); ?>
...
function deleteTeam(tid){
  if (window.confirm('ID '+tid+' のデータを削除しますか？')) {
    location.href = "<?php echo $this->_tpl_vars['root']; ?>
admin/editor.php?action=deleteteam&teamid="+tid;
  }
}
    </script>
  </head>
...
admin/editor.php?action=editteam" class="btn btn-secondary">新規チーム作成</a></p>

          <table width="90%" border="0" cellspacing="2" cellpadding="5">
            <tbody>
              <tr class="whitetitle">
                <td width="10%" align="center" bgcolor="#005296">チームID</td>
                <td width="15%" align="center" bgcolor="#005296">チーム区分</td>
                <td width="15%" align="center" bgcolor="#005296">年号</td>
                <td align="center" bgcolor="#005296">チーム名</td>
...
admin/editor.php?action=editteam&teamid=<?php echo ((is_array($_tmp=$this->_tpl_vars['i']['teamid'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['i']['teamid'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a></td>
                ...
                <td><strong><?php echo ((is_array($_tmp=$this->_tpl_vars['i']['year'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</strong></td>
                ...
                <td>【<a href="#" onclick="deleteTeam(<?php echo ((is_array($_tmp=$this->_tpl_vars['i']['teamid'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
);">削除</a>】</td>
              </tr>
